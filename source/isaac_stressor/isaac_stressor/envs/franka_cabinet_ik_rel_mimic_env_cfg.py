...
@configclass
class FrankaCabinetIKRelMimicEnvCfg(FrankaCabinetEnvCfg, MimicEnvCfg):
    """
    Isaac Lab Mimic environment config class for Franka Cabinet IK Rel env.
    """
    ...
    def __post_init__(self):
        ...
        # # The __post_init__() above only calls the init for FrankaCabinetEnvCfg and not MimicEnvCfg
        # # https://stackoverflow.com/questions/59986413/achieving-multiple-inheritance-using-python-dataclasses

        # Override the existing values
        self.datagen_config.name = "demo_src_cabinet_isaac_lab_task_D0"
